...
if __name__ == "__main__":
    ...
    parser.add_argument("-test_lang", "--test_lang",type=str, default = 'en', help="test languages")
    ...
    if args.lang == 'en':
        ...
        if args.ver == 'nes':
            gold_set_for_validation=set(pd.read_csv(path+'ACTER/en/equi/annotations/equi_en_terms_nes.ann', delimiter="\t", names=["Term", "Label"])["Term"])
            ...
            gold_set_for_validation=set(pd.read_csv(path+'ACTER/en/equi/annotations/equi_en_terms.ann', delimiter="\t", names=["Term", "Label"])["Term"])
        ...
        if args.ver == 'nes':
            gold_set_for_validation=set(pd.read_csv(path+'ACTER/fr/equi/annotations/equi_fr_terms_nes.ann', delimiter="\t", names=["Term", "Label"])["Term"])
            gold_set_for_test=set(pd.read_csv(path+'ACTER/en/htfl/annotations/htfl_en_terms_nes.ann', delimiter="\t", names=["Term", "Label"])["Term"])
            gold_set_for_test1=set(pd.read_csv(path+'ACTER/fr/htfl/annotations/htfl_fr_terms_nes.ann', delimiter="\t", names=["Term", "Label"])["Term"])
            gold_set_for_test2=set(pd.read_csv(path+'ACTER/nl/htfl/annotations/htfl_nl_terms_nes.ann', delimiter="\t", names=["Term", "Label"])["Term"])
        else:
            gold_set_for_validation=set(pd.read_csv(path+'ACTER/fr/equi/annotations/equi_fr_terms.ann', delimiter="\t", names=["Term", "Label"])["Term"])
            gold_set_for_test=set(pd.read_csv(path+'ACTER/en/htfl/annotations/htfl_en_terms.ann', delimiter="\t", names=["Term", "Label"])["Term"])
            gold_set_for_test1=set(pd.read_csv(path+'ACTER/fr/htfl/annotations/htfl_fr_terms.ann', delimiter="\t", names=["Term", "Label"])["Term"])
            gold_set_for_test2=set(pd.read_csv(path+'ACTER/nl/htfl/annotations/htfl_nl_terms.ann', delimiter="\t", names=["Term", "Label"])["Term"])
        ...
        if args.ver == 'nes':
            gold_set_for_validation=set(pd.read_csv(path+'ACTER/nl/equi/annotations/equi_nl_terms_nes.ann', delimiter="\t", names=["Term", "Label"])["Term"])
            gold_set_for_test=set(pd.read_csv(path+'ACTER/en/htfl/annotations/htfl_en_terms_nes.ann', delimiter="\t", names=["Term", "Label"])["Term"])
            gold_set_for_test1=set(pd.read_csv(path+'ACTER/fr/htfl/annotations/htfl_fr_terms_nes.ann', delimiter="\t", names=["Term", "Label"])["Term"])
            gold_set_for_test2=set(pd.read_csv(path+'ACTER/nl/htfl/annotations/htfl_nl_terms_nes.ann', delimiter="\t", names=["Term", "Label"])["Term"])
        else:
            gold_set_for_validation=set(pd.read_csv(path+'ACTER/nl/equi/annotations/equi_nl_terms.ann', delimiter="\t", names=["Term", "Label"])["Term"])
            gold_set_for_test=set(pd.read_csv(path+'ACTER/en/htfl/annotations/htfl_en_terms.ann', delimiter="\t", names=["Term", "Label"])["Term"])
            gold_set_for_test1=set(pd.read_csv(path+'ACTER/fr/htfl/annotations/htfl_fr_terms.ann', delimiter="\t", names=["Term", "Label"])["Term"])
            gold_set_for_test2=set(pd.read_csv(path+'ACTER/nl/htfl/annotations/htfl_nl_terms.ann', delimiter="\t", names=["Term", "Label"])["Term"])

    trainings_data = corp + wind
    val_data = equi 
